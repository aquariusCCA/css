...
topics: [background-repeat, background-position, background-attachment, background複合寫法]
summary: "說明背景圖片如何控制平鋪、位置、固定效果，並整理 background 複合寫法。"
---
...
| 值 | 行為 |
| --- | --- |
| `scroll` | 預設值；在一般頁面背景中，背景會隨元素在頁面中移動 |
