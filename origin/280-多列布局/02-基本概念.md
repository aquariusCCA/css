...
> 
> 
> ![基本概念_行和列.png](./assets/images/multi-column-layout-basic-concepts-img-001-8f84f7.png)
> 
...
- 正常情況下，n 行和 m 列會產生 n x m 個單元格。比如，3 行 3 列會產生 9 個單元格。
    ...
    ![基本概念_單元格.png](./assets/images/multi-column-layout-basic-concepts-img-002-ad15de.png)
...
- 正常情況下，`n` 行有 `n + 1` 根水平網格線，`m` 列有 `m + 1` 根垂直網格線，比如三行就有四根水平網格線。
    ...
    ![基本概念_網格線.png](./assets/images/multi-column-layout-basic-concepts-img-003-34eb06.png)
