...
![同一 BFC 中塊級盒子垂直排列示意圖](./assets/images/bfc-img-001-0bb5fa.png)
...
![float 元素造成外層容器高度塌陷](./assets/images/bfc-img-002-d47b0a.png)
...
![外層容器建立 BFC 後包住 float 元素](./assets/images/bfc-img-003-0dfddf.png)
...
![兩個段落垂直 margin 重疊效果](./assets/images/bfc-img-004-caa435.png)
...
![建立新 BFC 後避免段落 margin 重疊](./assets/images/bfc-img-005-cc123f.png)
...
![float 元素遮住後方普通區塊](./assets/images/bfc-img-006-e511a5.png)
...
![普通區塊建立 BFC 後避開 float 元素](./assets/images/bfc-img-007-9f431a.png)
