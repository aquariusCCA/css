...
![浮動元素會脫離標準流.png](./assets/images/float-characteristics-img-001-73cc54.png)
...
![如果多個盒子都設置了浮動則它們會按照屬性值一行內顯示並且頂端對齊排列.png](./assets/images/float-characteristics-img-002-afa13a.png)
