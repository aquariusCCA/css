...
>  
> ![background-position 參數類型與背景位置說明表](./assets/images/05-background-position-img-001-98ca84.png)
> 
...
div {
	...
	/* 此时水平一定是靠右侧对齐，第二个参数省略 y 轴是 垂直居中显示的 */
	/* background-position: right; */
	
	/* 此时第一个参数一定是 top y轴 顶部对齐   第二个参数省略x  轴是 水平居中显示的 */
