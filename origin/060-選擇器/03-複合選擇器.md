...
> 
> ![CSS 屬性選擇器對照表，列出存在屬性與屬性值匹配語法](./assets/images/compound-selectors-img-001-546d82.png)
...
> 
> ![CSS 結構偽類選擇器對照表，列出 first-child、last-child 與 nth-of-type 等語法](./assets/images/compound-selectors-img-002-c8df75.png)
...
> 
> ![nth-child 公式取值表，列出 2n、2n+1、5n、n+5 與 -n+5 的匹配範圍](./assets/images/compound-selectors-img-003-4bf38c.png)
...
> 
> ![CSS 偽元素選擇器對照表，說明 before 與 after 插入內容的位置](./assets/images/compound-selectors-img-004-f4321d.png)
